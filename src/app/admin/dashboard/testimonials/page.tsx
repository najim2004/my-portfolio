...
export type StatusFilter = TestimonialStatus | "all";
...
export default function TestimonialsPage(): JSX.Element {
  ...
  const handleViewClick = (testimonial: Testimonial): void => {
  ...
  const getStatusBadgeStyles = (status: TestimonialStatus): string => {
    switch (status) {
      case "approved":
                ...
                {filteredTestimonials.length === 0 ? (
                  ...
                  filteredTestimonials.map((testimonial) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <Badge
                          className={getStatusBadgeStyles(testimonial.status)}
                        >
        ...
        <DialogContent className="bg-gray-800 border-gray-700 text-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400">
              Review the full testimonial content.
            </DialogDescription>
          </DialogHeader>
          {selectedTestimonial && (
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge
                  className={getStatusBadgeStyles(selectedTestimonial.status)}
                >
